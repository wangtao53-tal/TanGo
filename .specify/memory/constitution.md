<!--
Sync Impact Report:
Version: 2.4.0 → 2.5.0 (MVP版本分支管理规范)
新增治理规则:
  - 分支管理规范（MVP版本统一使用dev-mvp-20251218分支，禁止一个功能一个分支）
修改原则:
  - 无
模板更新状态:
  - ✅ .specify/memory/constitution.md (已更新治理规则部分，新增分支管理规范)
  - ✅ .specify/templates/plan-template.md (已更新Branch说明，明确使用dev-mvp-20251218)
  - ✅ .specify/templates/spec-template.md (已更新Feature Branch说明，明确使用dev-mvp-20251218)
