...
export const EnglishCard: React.FC<EnglishCardProps> = ({
  ...
  return (
    <article
      className={`flex flex-col rounded-[2.5rem] bg-white border-4 border-sky-blue shadow-card relative transition-transform hover:-translate-y-2 duration-300 group overflow-hidden ${className}`}
    >
      {/* 顶部图片区域（45%高度） */}
